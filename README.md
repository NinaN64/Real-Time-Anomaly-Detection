...
java -jar KafkaEngine/target/kafka-engine-1.0-SNAPSHOT.jar --dataset newsgroups --seed 7 --subset-size 2000
...
### 6. Analyze results
python analyze_results.py --input evaluation_results.csv --table51